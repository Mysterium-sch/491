...
module nios_system_mm_interconnect_0 (
	...
	wire    [5:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> new_sdram_controller_0_s1_agent:cp_channel
	...
	wire    [5:0] cmd_demux_src3_channel;                                                             // cmd_demux:src3_channel -> crosser_002:in_channel
	...
	wire    [5:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> cmd_mux_003:sink0_channel
	...
	wire  [104:0] crosser_003_out_data;                                                               // crosser_003:out_data -> cmd_mux_003:sink1_data
	wire          crosser_003_out_ready;                                                              // cmd_mux_003:sink1_ready -> crosser_003:out_ready
	wire    [5:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> cmd_mux_003:sink1_channel
	...
	wire  [104:0] rsp_demux_003_src0_data;                                                            // rsp_demux_003:src0_data -> crosser_006:in_data
	...
	wire  [104:0] crosser_006_out_data;                                                               // crosser_006:out_data -> rsp_mux:sink3_data
	wire          crosser_006_out_ready;                                                              // rsp_mux:sink3_ready -> crosser_006:out_ready
	wire    [5:0] crosser_006_out_channel;                                                            // crosser_006:out_channel -> rsp_mux:sink3_channel
	...
	wire  [104:0] rsp_demux_003_src1_data;                                                            // rsp_demux_003:src1_data -> crosser_007:in_data
	...
	wire  [104:0] crosser_007_out_data;                                                               // crosser_007:out_data -> rsp_mux_001:sink1_data
	wire          crosser_007_out_ready;                                                              // rsp_mux_001:sink1_ready -> crosser_007:out_ready
	wire    [5:0] crosser_007_out_channel;                                                            // crosser_007:out_channel -> rsp_mux_001:sink1_channel
	...
	wire          performance_counter_0_control_slave_agent_rdata_fifo_out_valid;                     // performance_counter_0_control_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] performance_counter_0_control_slave_agent_rdata_fifo_out_data;                      // performance_counter_0_control_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          performance_counter_0_control_slave_agent_rdata_fifo_out_ready;                     // avalon_st_adapter_001:in_0_ready -> performance_counter_0_control_slave_agent_rdata_fifo:out_ready
