...
module nios_system_mm_interconnect_0 (
	...
	wire  [104:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> new_sdram_controller_0_s1_agent:cp_data
	...
	wire  [104:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> keys_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // keys_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> keys_s1_agent:cp_channel
	...
	wire  [104:0] new_sdram_controller_0_s1_agent_rp_data;                                            // new_sdram_controller_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [104:0] keys_s1_agent_rp_data;                                                              // keys_s1_agent:rp_data -> router_006:sink_data
	...
	wire    [4:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_002:sink1_channel
	...
	wire    [4:0] rsp_demux_002_src0_channel;                                                         // rsp_demux_002:src0_channel -> crosser_002:in_channel
	...
	wire    [4:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink2_channel
	...
	wire    [4:0] rsp_demux_002_src1_channel;                                                         // rsp_demux_002:src1_channel -> crosser_003:in_channel
