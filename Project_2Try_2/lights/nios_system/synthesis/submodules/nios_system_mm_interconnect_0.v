...
module nios_system_mm_interconnect_0 (
	...
	wire  [104:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> keys_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // keys_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> keys_s1_agent:cp_channel
	...
	wire  [104:0] keys_s1_agent_rp_data;                                                              // keys_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [104:0] cmd_demux_src6_data;                                                                // cmd_demux:src6_data -> crosser_004:in_data
	...
	wire  [104:0] crosser_004_out_data;                                                               // crosser_004:out_data -> cmd_mux_006:sink0_data
	...
	wire    [6:0] crosser_005_out_channel;                                                            // crosser_005:out_channel -> cmd_mux_004:sink1_channel
	...
	wire    [6:0] rsp_demux_src0_channel;                                                             // rsp_demux:src0_channel -> crosser_006:in_channel
	...
	wire    [6:0] crosser_006_out_channel;                                                            // crosser_006:out_channel -> rsp_mux:sink0_channel
	...
	wire    [6:0] rsp_demux_001_src0_channel;                                                         // rsp_demux_001:src0_channel -> crosser_007:in_channel
	...
	wire    [6:0] crosser_007_out_channel;                                                            // crosser_007:out_channel -> rsp_mux:sink1_channel
	...
	wire    [6:0] rsp_demux_002_src0_channel;                                                         // rsp_demux_002:src0_channel -> crosser_008:in_channel
	...
	wire    [6:0] crosser_008_out_channel;                                                            // crosser_008:out_channel -> rsp_mux:sink2_channel
	...
	wire    [6:0] rsp_demux_004_src0_channel;                                                         // rsp_demux_004:src0_channel -> crosser_009:in_channel
	...
	wire    [6:0] crosser_009_out_channel;                                                            // crosser_009:out_channel -> rsp_mux:sink4_channel
	...
	wire  [104:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> crosser_010:in_data
	wire          rsp_demux_004_src1_ready;                                                           // crosser_010:in_ready -> rsp_demux_004:src1_ready
	wire    [6:0] rsp_demux_004_src1_channel;                                                         // rsp_demux_004:src1_channel -> crosser_010:in_channel
	...
	wire  [104:0] crosser_010_out_data;                                                               // crosser_010:out_data -> rsp_mux_001:sink1_data
